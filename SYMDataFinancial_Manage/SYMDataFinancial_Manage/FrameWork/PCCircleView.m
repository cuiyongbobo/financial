...
-(void)lockViewPrepare{
    ...
    if ([[NSUserDefaults standardUserDefaults]objectForKey:LoginPage]) {
        [[NSUserDefaults standardUserDefaults]removeObjectForKey:LoginPage];
        [[NSUserDefaults standardUserDefaults]synchronize];
        [self setCenter:CGPointMake([UIScreen mainScreen].bounds.size.width/2, CircleViewCenterY)];
    }else{
        [self setCenter:CGPointMake([UIScreen mainScreen].bounds.size.width/2, CircleViewCenterY-100*SYMHEIGHTRATESCALE)];
    }
