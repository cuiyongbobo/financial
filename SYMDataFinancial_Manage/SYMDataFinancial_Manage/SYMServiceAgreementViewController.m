//
//  SYMServiceAgreementViewController.m
//  SYMDataFinancial_Manage
//
//  Created by cuiyong on 15/12/28.
...
@interface SYMServiceAgreementViewController ()
{
...
@implementation SYMServiceAgreementViewController
...
- (void)viewDidLoad {
    ...
    NSString *urlstr=[NSString stringWithFormat:@"%@",self.weburl];
    // 1. URL 定位资源,需要资源的地址
