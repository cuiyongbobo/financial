//
//  SYMexchangeRateViewController.m
...
@interface SYMexchangeRateViewController ()
{
...
@implementation SYMexchangeRateViewController
...
- (void)viewDidLoad {
    ...
    NSString *urlstr=[NSString stringWithFormat:@"http://%@",self.weburl];
    // 1. URL 定位资源,需要资源的地址
